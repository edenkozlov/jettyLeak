...
const DASHBOARD_ITEMS = [
  {
    ...
    desc: 'Track total water usage with clear, real-time trends.',
  },
  {
    icon: (
      <>
    ...
    title: 'Breakdown by fixture',
    desc: 'Understand where your water is going.',
  },
  {
    icon: (
      <>
    ...
    desc: 'See which fixtures need attention instantly.',
  },
  {
    icon: <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />,
    title: 'Performance tracking',
    desc: 'Monitor how fixtures change over time.',
  },
  {
    icon: (
      <>
    ...
    desc: 'See how much water and cost can be reduced.',
  },
  {
    icon: (
      <>
    ...
    desc: 'Compare buildings from one dashboard.',
  },
] as const
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6">
        <div className="grid items-center gap-10 lg:grid-cols-[auto_1fr] lg:gap-14">
          <div className="relative mx-auto lg:mx-0">
            ...
            <img
              src={leakImg}
              alt="Beluga mobile app telemetry data"
          ...
          <div>
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-gray-500 sm:text-[16px]">
              Full visibility into your building's water system — from high-level usage to individual
              fixture performance.
            </p>
