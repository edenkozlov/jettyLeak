...
const P = 'flume' as const

const linkCls =
  'text-indigo-600 underline decoration-indigo-600/30 underline-offset-4 transition hover:decoration-indigo-600'
  ...
  return (
    <div className="min-h-screen bg-white antialiased">
      ...
      <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-20">
        <div className="space-y-16 sm:space-y-24">
          ...
          <section>
            ...
            <div className="mx-auto mt-10 grid max-w-3xl gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-2 text-[14px] leading-relaxed text-gray-500 sm:text-[15px]">{t(`${P}.midLeftP`)}</p>
              </div>
              <div className="rounded-2xl border border-indigo-200 bg-indigo-50/40 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-2 text-[14px] leading-relaxed text-gray-500 sm:text-[15px]">{t(`${P}.midRightP`)}</p>
              </div>
            </div>
          </section>
          ...
          <section className="mx-auto max-w-2xl">
            ...
            <div className="mt-4 space-y-4 text-[15px] leading-relaxed text-gray-600 sm:text-[16px]">
              ...
              <p>{t('shell.aboutStandardP2')}</p>
            </div>
          </section>

          <section className="mx-auto max-w-2xl">
            <h3 className="text-[16px] font-semibold text-gray-900 sm:text-[18px]">{t(`${P}.similarTitle`)}</h3>
            <p className="mt-2 text-[14px] leading-relaxed text-gray-500 sm:text-[15px]">
              <Trans
                ns="comparePages"
                i18nKey={`${P}.similarBody`}
                components={[
                  <Link key="flo" to="/flo-by-moen-alternative" className={linkCls} />,
                  <Link key="phyn" to="/phyn-alternative" className={linkCls} />,
                ]}
              />
            </p>
          </section>
        ...
        <CompareCta competitorName={t(`${P}.ctaCompetitorName`)} competitorUrl="https://flumewater.com/" />
