      ...
      <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-20">
        <div className="space-y-16 sm:space-y-24">
          <section className="mx-auto max-w-2xl">
            <h2 className="text-[20px] font-bold tracking-tight text-gray-900 sm:text-[24px]">{t(`${P}.introSubheading`)}</h2>
        ...
        <CompareCta competitorName={t(`${P}.ctaCompetitorName`)} competitorUrl="https://www.wateralert.com/" />
