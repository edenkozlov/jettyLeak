...
const PAGE_TITLE = 'Beluga vs Alert Labs: Water Monitoring Systems Compared'
const META_DESCRIPTION =
  'Compare Beluga and Alert Labs. Understand differences in water monitoring deployment, installation, and system visibility.'

const COMPARISON_ROWS: { feature: string; beluga: string; alertLabs: string }[] = [
  {
    feature: 'Core purpose',
    beluga: 'Water intelligence & system visibility',
    alertLabs: 'Leak detection + water management',
  },
  {
    feature: 'Installation',
    beluga: 'Non-invasive (single sensor)',
    alertLabs: 'Multiple sensors across building',
  },
  {
    feature: 'Leak detection',
    beluga: 'Yes (pattern/anomaly-based)',
    alertLabs: 'Yes (sensor + flow-based alerts)',
  },
  { feature: 'Automatic shutoff', beluga: 'Not core feature', alertLabs: 'Available' },
  {
    feature: 'Usage insights',
    beluga: 'System-wide intelligence',
    alertLabs: 'Minute-by-minute flow tracking',
  },
  { feature: 'Deployment complexity', beluga: 'Low', alertLabs: 'Moderate (multi-sensor setup)' },
  {
    feature: 'Target use case',
    beluga: 'Commercial / multi-unit',
    alertLabs: 'Commercial / multi-building portfolios',
  },
  {
    feature: 'Monitoring approach',
    beluga: 'Behavioral + pattern learning',
    alertLabs: 'Sensor-driven + alerts',
  },
]

const FAQ_ITEMS: { q: string; a: string }[] = [
  {
    q: 'Does Alert Labs require multiple devices?',
    a: 'Yes. Their system typically uses multiple sensors deployed across a building to detect leaks and monitor conditions.',
  },
  {
    q: 'Is Beluga less detailed since it uses fewer sensors?',
    a: 'Beluga approaches the problem differently, using pattern recognition to infer system behavior rather than relying on multiple physical sensors.',
  },
]
      ...
      <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-20">
        <div className="space-y-16 sm:space-y-24">
          <section className="mx-auto max-w-2xl">
            <div className="space-y-4 text-[15px] leading-relaxed text-gray-600 sm:text-[16px]">
              <p>
                Water monitoring systems for buildings vary widely in how they are deployed and what
                they prioritize.
              </p>
              <p>
                This page compares Beluga and Alert Labs based on publicly available information to
                highlight differences in approach, installation, and system visibility.
              </p>
            </div>
          </section>
              ...
              <table className="w-full min-w-[560px] border-collapse text-left text-[14px] sm:text-[15px]">
                <thead>
                  <tr className="border-b-2 border-gray-200">
                    ...
                    <th className="py-3 pl-4 font-semibold text-gray-700">Alert Labs</th>
                  </tr>
                </thead>
                <tbody>
                  {COMPARISON_ROWS.map((row, i) => (
                    <tr key={row.feature} className={i % 2 === 0 ? 'bg-gray-50/60' : ''}>
                      ...
                      <td className="py-3 pl-4 text-gray-600">{row.alertLabs}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <section>
            ...
            <div className="mx-auto mt-10 grid max-w-3xl gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
                <h3 className="text-[16px] font-bold text-gray-900 sm:text-[18px]">Alert Labs</h3>
                <p className="mt-2 text-[14px] leading-relaxed text-gray-500 sm:text-[15px]">
                  Alert Labs provides a sensor-based water monitoring system that combines flow
                  sensors, leak detectors, and a centralized platform (AlertAQ). It delivers alerts,
                  tracks water usage, and can support shutoff systems.
                </p>
                <p className="mt-3 text-[14px] leading-relaxed text-gray-500 sm:text-[15px]">
                  Their approach is focused on coverage and visibility across multiple points in a
              ...
              <div className="rounded-2xl border border-indigo-200 bg-indigo-50/40 p-6 shadow-sm sm:p-8">
                ...
                <p className="mt-2 text-[14px] leading-relaxed text-gray-500 sm:text-[15px]">
                  Beluga focuses on understanding the system from a single point of measurement, using
                  pattern recognition to identify fixtures, inefficiencies, and anomalies over time.
                </p>
                <p className="mt-3 text-[14px] leading-relaxed text-gray-500 sm:text-[15px]">
                  Rather than deploying multiple sensors, it aims to extract system-level intelligence
                  from minimal hardware.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="mx-auto mt-10 grid max-w-3xl gap-6 sm:grid-cols-2">
              <div className="rounded-2xl border border-gray-200 bg-white p-6 sm:p-8">
                ...
                <ul className="mt-4 space-y-2 text-[14px] leading-relaxed text-gray-600 sm:text-[15px]">
                  <li className="flex items-start gap-2">
                    ...
                    You want sensor coverage across multiple areas
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-gray-400" />
                    You need alerts tied to specific locations
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-gray-400" />
                    You manage large portfolios requiring distributed monitoring
                  </li>
                </ul>
              </div>
              <div className="rounded-2xl border border-indigo-200 bg-indigo-50/40 p-6 sm:p-8">
                ...
                <ul className="mt-4 space-y-2 text-[14px] leading-relaxed text-gray-600 sm:text-[15px]">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-indigo-400" />
                    You prefer a non-invasive setup
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="mt-1.5 block h-1.5 w-1.5 shrink-0 rounded-full bg-indigo-400" />
                    You are focused on system-level understanding and long-term insights
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="mx-auto max-w-2xl rounded-xl border border-gray-200 bg-gray-50 p-5 sm:p-6">
            ...
            <p className="mt-2 text-[13px] leading-relaxed text-gray-400">
              ...
              sources and may change. This content is not affiliated with or endorsed by Alert Labs.
            </p>
          </section>
        </div>
        ...
        <div className="mt-16 border-t border-gray-100 pt-12 sm:mt-24 sm:pt-16">
          ...
          <div className="mx-auto mt-12 max-w-lg border-t border-gray-100 pt-12 text-center sm:text-left">
            <h2 className="text-[22px] font-bold tracking-tight text-gray-900 sm:text-[28px]">Get Alert Labs</h2>
            <p className="mt-2 text-[15px] leading-relaxed text-gray-600 sm:text-[16px]">
              Product details are on Alert Labs&apos; site—we don&apos;t sell or install their system.
            </p>
            <a
              href="https://alertlabs.com/"
              target="_blank"
