              ...
              {showcaseOnLanding.map((b) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    {b.cityLine ? (
                      <p className="mt-1 text-[13px] text-gray-500">{b.cityLine}</p>
                    ) : null}
                  </div>
                </article>
              ))}
...
function LandingBhiTrendChart() {
  ...
  return (
    <div
      className="flex w-full flex-col rounded-2xl border border-gray-200/80 bg-white p-5 shadow-lg shadow-indigo-500/[0.07] ring-1 ring-black/[0.02] sm:p-6 lg:h-full lg:min-h-0"
    ...
    >
      ...
      {/* Fixed height: ResponsiveContainer needs a definite pixel height (flex % collapses on mobile). */}
      <div className="mt-2 h-[200px] w-full min-w-0 sm:h-[220px] lg:h-[240px]">
