...
const STEPS: Step[] = [
  ...
  {
    n: '02',
    tag: 'Proprietary sensing',
    title: 'Your meter already knows everything. We listen to it.',
    body: 'Your water meter has been spinning every time water moves through your building. Our proprietary technology reads that signal continuously and with precision, turning raw mechanical movement into a live picture of everything happening inside your pipes.',
    image: meterImg,
    alt: 'Proprietary sensor reading the water meter signal',
  },
  {
    n: '03',
    tag: 'Fixture intelligence',
    title: 'Every fixture. One signal.',
    body: 'Our model decodes the flow stream and identifies each appliance in your building, what it is, how long it ran, and how much water it used. More than that, it can tell you if something is wrong with any toilet, sink, shower, or the pipes leading up to it, without a single additional sensor.',
  ...
  {
    n: '05',
    tag: 'Water waste and savings',
    title: "Most buildings waste water they don't even know about.",
    body: "Research shows buildings waste an average of 25 to 30% of their water through inefficiencies that go completely undetected. Beluga finds them. Without visibility into how your building actually behaves, that waste just compounds quietly on every bill.",
    image: wasteImg,
    alt: 'A water drop equated to a coin, water as money',
  },
  {
    n: '06',
    tag: 'Benchmark and efficiency scoring',
    title: 'Every fixture gets graded against the standard.',
    body: 'Is your toilet flushing 2.4 times more per flush than it did last month? Beluga tracks each fixture over time and compares it against two benchmarks: how your own building has historically performed, and how fixtures of that type should behave across the board. You see degradation before it becomes a problem.',
    image: benchmarkImg,
    alt: 'Fixture efficiency scores measured against benchmarks',
  },
  {
    n: '07',
